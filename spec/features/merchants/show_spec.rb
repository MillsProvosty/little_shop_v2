...
RSpec.describe 'Merchant Show page' do
  context 'when I visit my dashboard' do
    ...
    describe "I see an area with statistics" do
      ...
      it "shows name of user: with most orders, who bought the most total items and total quantity, and top 3 users who have spent the most money and total amount they've spent. " do

        expect(page).to have_content("Top 3 Spenders")
        expect(page).to have_content("Top 3 Spenders")
